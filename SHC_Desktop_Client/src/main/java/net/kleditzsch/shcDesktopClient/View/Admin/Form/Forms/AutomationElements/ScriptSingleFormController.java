...
import net.kleditzsch.shcCore.Automation.Devices.Switchable.ScriptSingle;
 ...
 */
public class ScriptSingleFormController {
    ...
    @FXML // fx:id="inputCommand"
    private TextArea inputCommand; // Value injected by FXMLLoader

    /**
     * Datenelement
     */
    protected ScriptSingle element;
    ...
    void save(ActionEvent event) {
        ...
        if(!validationSupport.isInvalid()) {
            ...
            element.setCommand(inputCommand.getText());
    ...
    void initialize() {
        ...
        assert inputCommand != null : "fx:id=\"inputCommand\" was not injected: check your FXML file 'ScriptSingleForm.fxml'.";
        ...
        validationSupport.registerValidator(inputCommand, Validator.createEmptyValidator("Das Kommando muss ausgefüllt werden"));
    ...
    public ScriptSingle getElement() {
        return element;
    }

    public void setElement(ScriptSingle element) {
        ...
        inputCommand.setText(element.getCommand());
